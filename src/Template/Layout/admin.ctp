...
<head>
    ...
    <![endif]-->
        ...
        #particles-js {
           ...
           background: linear-gradient(135deg, #a90505, #070706d4);/* Gradiente de fondo */
        }
        .content-wrapper {
            position: relative;
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li><a href="<?php echo $this->Url->build(['controller' => 'Users', 'action' => 'adminorders']); ?>"><i
                            class="fa fa-credit-card"></i> <span><?= __('Market Orders') ?></span></a></li>
