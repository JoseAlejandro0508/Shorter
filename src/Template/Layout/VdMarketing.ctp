...
<head>
    ...
    <style>
        ...
        #particles-js {
            ...
            background: linear-gradient(135deg, #e60606, #02e48aff); /* Gradiente de fondo */
        }
        .content-wrapper {
            position: relative;
                ...
                <li class="dropdown messages-menu">
                    ...
                    <li class="dropdown messages-menu">
                        ...
                        <a href="<?= $this->Url->build([
                            ...
                            <span class="hidden-xs"><?= __('Available Balance') ?>: </span>$<?= h($this->fetch('VdBalance')); ?>
                        </a>
                    </li>
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    ...
                    <li><a href="<?php echo $this->Url->build(['controller' => 'Users', 'action' => 'orders']); ?>"><span><?= __('Orders') ?></span></a></li>
