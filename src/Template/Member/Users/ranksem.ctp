        ...
        <table class="table table-striped" id="table_info">
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        <figure class="rank-figure" id="f1"><?= h($poslast[0]->username) ?></figure>
                    </td>
                    <td>
                        <?=$total_views_per_userlast[$poslast[0]->id]?></figure>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <figure class="rank-figure" id="f2"><?= h($poslast[1]->username) ?></figure>
                    </td>
                    <td>
                        <?=$total_views_per_userlast[$poslast[1]->id]?></figure>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <figure class="rank-figure" id="f3"><?= h($poslast[2]->username) ?></figure>
                    </td>
                    <td>
                        <?=$total_views_per_userlast[$poslast[2]->id]?></figure>
                    </td>
                </tr>
