...
<div class="nav-tabs-custom">
    ...
    <div class="tab-content">
        ...
        <div role="tabpanel" id="links" class="tab-pane fade in active">
            ...
            <div class="row">
                <div class="col-sm-2"><?= __('Blocked Countries ') ?></div>
                <div class="col-sm-10">
                    <?=
                    $this->Form->control('Options.' . $settings['blocked_countries']['id'] . '.value', [
                        'label' => false,
                        'class' => 'form-control',
                        'type' => 'textarea',
                        'value' => $settings['blocked_countries']['value'],
                    ]);
                    ?>
                    <span class="help-block"><?= __('Paises deshabilitados para los anuncios.') ?></span>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-2"><?= __('URL de redireccion para los paises bloqueados') ?></div>
                <div class="col-sm-10">
                    <?=
                    $this->Form->control('Options.' . $settings['url_blocked_countries']['id'] . '.value', [
                        'label' => false,
                        'class' => 'form-control',
                        'type' => 'textarea',
                        'value' => $settings['url_blocked_countries']['value'],
                    ]);
                    ?>
                    <span class="help-block"><?= __('Los paises bloqueados seran redirigidos a esta URL') ?></span>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-10">
                    <?=
                    $this->Form->control('Options.' . $settings['ScriptStatus']['id'] . '.value', [
                        'label' => false,
                        'options' => [
                            'on' => __('on'),
                            'off' => __('off'),
                        ],
                        'value' => $settings['ScriptStatus']['value'],
                        'class' => 'form-control',
                    ]);
                    ?>
                </div>
            ...
            <div class="row">
                <div class="col-sm-2"><?= __('RandomScroll') ?></div>
                <div class="col-sm-10">
                    <?=
                    $this->Form->control('Options.' . $settings['ScritpScroll']['id'] . '.value', [
                        'label' => false,
                        'options' => [
                            'on' => __('on'),
                            'off' => __('off'),
                        ],
                        'value' => $settings['ScritpScroll']['value'],
                        'class' => 'form-control',
                    ]);
                    ?>
                </div>
            ...
            <div class="row">
                <div class="col-sm-2"><?= __('Script Type') ?></div>
                <div class="col-sm-10">
                    <?=
                    $this->Form->control('Options.' . $settings['ScryptType']['id'] . '.value', [
                        'label' => false,
                        'options' => [
                            'button' => __('button'),
                            'img' => __('img'),
                        ],
                        'value' => $settings['ScryptType']['value'],
                        'class' => 'form-control',
                    ]);
                    ?>
                </div>
            ...
            <div class="row">
                <div class="col-sm-2"><?= __('Blocked Countries for Script ') ?></div>
                <div class="col-sm-10">
                    <?=
                    $this->Form->control('Options.' . $settings['ScriptBlockedCountry']['id'] . '.value', [
                        'label' => false,
                        'class' => 'form-control',
                        'type' => 'textarea',
                        'value' => $settings['ScriptBlockedCountry']['value'],
                    ]);
                    ?>
            ...
            <div class="row">
                ...
                <div class="col-sm-10">
                    <?=
                    $this->Form->control('Options.' . $settings['ProxyFilter']['id'] . '.value', [
                        'label' => false,
                        'options' => [
                            'on' => __('on'),
                            'off' => __('off'),
                        ],
                        'value' => $settings['ProxyFilter']['value'],
                        'class' => 'form-control',
                    ]);
                    ?>
                    <span class="help-block"><?= __('Activa o desactiva la deteccion de proxys') ?></span>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-2"><?= __('API KEY del Proxy') ?></div>
                <div class="col-sm-10">
                    <?=
                    $this->Form->control('Options.' . $settings['ProxyAPI']['id'] . '.value', [
                        'label' => false,
                        'class' => 'form-control',
                        'type' => 'textarea',
                        'value' => $settings['ProxyAPI']['value'],
                    ]);
                    ?>
                    <span class="help-block"><?= __('Coloque su API KEY de proxycheck.io') ?></span>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-2"><?= __('Url de Redireccion de Proxy') ?></div>
                <div class="col-sm-10">
                    <?=
                    $this->Form->control('Options.' . $settings['ProxyRedirect']['id'] . '.value', [
                        'label' => false,
                        'class' => 'form-control',
                        'type' => 'textarea',
                        'value' => $settings['ProxyRedirect']['value'],
                    ]);
                    ?>
        ...
        <div role="tabpanel" id="market" class="tab-pane fade in">
            <p></p>
            <div class="row">
                <div class="col-sm-2"><?= __('Facebook Accounts Price') ?></div>
                <div class="col-sm-10">
                    <?=
                    $this->Form->control('Options.' . $settings['facebook_price']['id'] . '.value', [
                        'label' => false,
                        'class' => 'form-control',
                        'type' => 'text',
