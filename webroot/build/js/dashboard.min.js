if (
  ((function (t, e) {
    ...
    var T = (function (t) {
      ...
      function st(t, e, i, o) {
        ...
        if (!o && (d(e), (e = e || f), g)) {
          ...
          if (
            ...
            if (((m = t), (y = e), 1 === w && (U.test(t) || z.test(t)))) {
              for (
      ...
      (st.attr = function (t, e) {
        ...
        var o = i.attrHandle[e.toLowerCase()],
          r = o && _.call(i.attrHandle, e.toLowerCase()) ? o(t, e, !g) : void 0;
        return void 0 !== r
          ? r
          : n.attributes || !g
          ? t.getAttribute(e)
                        ...
                        for (
                          b =
                            (f =
                              (c =
                                (u =
                                  (p = (d = v)[x] || (d[x] = {}))[d.uniqueID] ||
                                  (p[d.uniqueID] = {}))[t] || [])[0] === C &&
                              c[1]) && c[2],
                            d = f && v.childNodes[f];
                          (d = (++f && d && d[g]) || (b = f = 0) || h.pop());
        ...
        return (
          ...
          ct(function (r, a, s, l) {
            var c,
              ...
              v = !t || (!r && e) ? g : Ct(g, d, t, s, l),
              m = n ? (o || (r ? t : h || i) ? [] : a) : v;
            if ((n && n(v, m, s, l), i))
              for (c = Ct(m, f), i(c, [], s, l), u = c.length; u--; )
                (p = c[u]) && (m[f[u]] = !(v[f[u]] = p));
            if (r) {
              if (o || t) {
                if (o) {
            ...
            } else (m = Ct(m === a ? m.splice(h, m.length) : m)), o ? o(null, a, m, l) : L.apply(a, m);
          })
        );
      }
      function $t(t) {
              ...
              (v = S(
                ...
                (u = function (t, e, n, a, u) {
                  ...
                  for (
                    ...
                    if (l && p) {
                      for (
                        h = 0, e || p.ownerDocument == f || (d(p), (n = !g));
                        (v = o[h++]);
                    ...
                    s && ((p = !v && p) && m--, t && b.push(p));
                  }
                  if (((m += y), s && y !== m)) {
                    for (h = 0; (v = r[h++]); ) v(b, x, e, n);
                    if (t) {
                      if (0 < m)
                        for (; y--; ) b[y] || x[y] || (x[y] = N.call(a));
                      x = Ct(x);
                    }
                    L.apply(a, x),
                      u &&
      ...
      if (((n = n || D), "string" == typeof t)) {
        ...
        if (i[1]) {
          if (
            ...
            w.merge(
              this,
              w.parseHTML(i[1], e && e.nodeType ? e.ownerDocument || e : v, !0)
            ),
            A.test(i[1]) && w.isPlainObject(e))
          )
        ...
        function (t, e) {
          w.fn[t] = function (n, i) {
            ...
            return (
              ...
              1 < this.length &&
                (L[t] || w.uniqueSort(o), j.test(t) && o.reverse()),
              this.pushStack(o)
            );
          };
        }
    ...
    (w.Callbacks = function (t) {
      ...
      w.extend({
          ...
          var n = [
            ...
            o = {
              ...
              then: function (e, i, o) {
                      ...
                      c = function () {
                        ...
                        if (!(e < r)) {
                          ...
                          (c =
                            ...
                            h(c)
                              ? o
                                ? c.call(t, a(r, n, R, o), a(r, n, P, o))
                                : (r++,
                                  c.call(
                                    t,
                                    a(r, n, R, o),
                                    a(r, n, P, o),
                                    a(r, n, R, n.notifyWith)
                                  ))
                              : (i !== R && ((s = void 0), (l = [t])),
                                (o || n.resolveWith)(s, l));
                        }
                ...
                return w
                  .Deferred(function (t) {
                    n[0][3].add(a(0, t, h(o) ? o : R, t.notifyWith)),
                      n[1][3].add(a(0, t, h(e) ? e : R)),
                      n[2][3].add(a(0, t, h(i) ? i : P));
                  })
                  .promise();
              },
              promise: function (t) {
        ...
        when: function (t) {
          ...
          if (
            e <= 1 &&
            (H(t, a.done(s(n)).resolve, a.reject, !e),
    ...
    function V(t) {
      return t.replace(B, "ms-").replace(z, U);
    }
    var Q = function (t) {
      ...
      w.fn.extend({
        data: function (t, e) {
          ...
          if (void 0 === t) {
            if (
              this.length &&
              ((o = Y.get(r)), 1 === r.nodeType && !J.get(r, "hasDataAttrs"))
            ) {
              for (n = a.length; n--; )
                a[n] &&
    ...
    var lt = {};
    function ct(t, e) {
      for (var n, i, o, r, a, s, l, c = [], u = 0, p = t.length; u < p; u++)
        (i = t[u]).style &&
          ((n = i.style.display),
          e
            ? ("none" === n &&
                ((c[u] = J.get(i, "display") || null),
                c[u] || (i.style.display = "")),
              "" === i.style.display &&
                at(i) &&
                (c[u] =
    ...
    (ut = v.createDocumentFragment().appendChild(v.createElement("div"))),
      (pt = v.createElement("input")).setAttribute("type", "radio"),
    ...
    function bt(t, e, n, i, o) {
      ...
      for (p.textContent = "", f = 0; (r = d[f++]); )
        if (i && -1 < w.inArray(r, i)) o && o.push(r);
          ...
          ((c = ot(r)), (a = vt(p.appendChild(r), "script")), c && mt(a), n)
        )
          for (u = 0; (r = a[u++]); ) ht.test(r.type || "") && n.push(r);
      return p;
    }
    var xt = /^([^.]*)(?:\.(.+)|)/;
    function wt() {
    ...
    function kt(t, e, n) {
      n
        ...
        : void 0 === J.get(t, e) && w.event.add(t, e, wt);
    }
    (w.event = {
      global: {},
            ...
            (f = g = (s = xt.exec(e[c]) || [])[1]),
              ...
              f &&
                ...
                (d = l[f]) ||
                  ...
                  (p.setup && !1 !== p.setup.call(t, i, h, a)) ||
            ...
            if (
              ...
              a &&
                ...
                ((p.teardown && !1 !== p.teardown.call(t, h, v.handle)) ||
                  w.removeEvent(t, f, v.handle),
                delete l[f]);
            } else for (f in l) w.event.remove(t, f + e[c], n, i, !0);
          w.isEmptyObject(l) && J.remove(t, "handle events");
        }
      },
      dispatch: function (t) {
        var e,
        ...
        if (
          ...
          for (
            a = w.event.handlers.call(this, l, c), e = 0;
      ...
      special: {
        ...
        click: {
          setup: function (t) {
            var e = this || t;
            return (
              dt.test(e.type) && e.click && E(e, "input") && kt(e, "click", wt),
              !1
            );
          },
          trigger: function (t) {
            var e = this || t;
            return (
              dt.test(e.type) && e.click && E(e, "input") && kt(e, "click"), !0
            );
          },
          _default: function (t) {
            var e = t.target;
      ...
      if (1 === e.nodeType) {
        if (J.hasData(t) && (s = J.get(t).events))
          for (o in (J.remove(e, "handle events"), s))
            for (n = 0, i = s[o].length; n < i; n++) w.event.add(e, o, s[o][n]);
        Y.hasData(t) && ((r = Y.access(t)), (a = w.extend({}, r)), Y.set(e, a));
      }
    }
    function Lt(t, e, n, i) {
      e = r(e);
      var o,
        ...
        v = e[0],
        m = h(v);
      if (m || (1 < d && "string" == typeof v && !f.checkClone && Et.test(v)))
        return t.each(function (o) {
          var r = t.eq(o);
          m && (e[0] = v.call(this, o, r.html())), Lt(r, e, n, i);
        });
      if (
        d &&
        ((a = (o = bt(e, t[0].ownerDocument, !1, t, i)).firstChild),
        1 === o.childNodes.length && (o = a),
        a || i)
      ) {
        for (l = (s = w.map(vt(o, "script"), Dt)).length; p < d; p++)
          (c = o),
            p !== g &&
              ((c = w.clone(c, !0, !0)), l && w.merge(s, vt(c, "script"))),
            n.call(t[p], c, p);
        if (l)
          for (
            u = s[s.length - 1].ownerDocument, w.map(s, Nt), p = 0;
            p < l;
            p++
          )
            (c = s[p]),
              ht.test(c.type || "") &&
                ...
                (c.src && "module" !== (c.type || "").toLowerCase()
                  ...
                  : y(c.textContent.replace(At, ""), c, u));
      }
      return t;
    }
    function Ot(t, e, n) {
      for (var i, o = e ? w.filter(e, t) : t, r = 0; null != (i = o[r]); r++)
        n || 1 !== i.nodeType || w.cleanData(vt(i)),
          i.parentNode &&
            (n && ot(i) && mt(vt(i, "script")), i.parentNode.removeChild(i));
      return t;
    }
    w.extend({
      ...
      clone: function (t, e, n) {
        ...
        if (
          ...
          for (a = vt(u), i = 0, o = (r = vt(t)).length; i < o; i++)
            (s = r[i]),
        ...
        if (e)
          if (n)
            for (
              r = r || vt(t), a = a || vt(u), i = 0, o = r.length;
              i < o;
              i++
            )
              jt(r[i], a[i]);
        ...
        return (
          0 < (a = vt(u, "script")).length && mt(a, !p && vt(t, "script")), u
        );
      },
      ...
      w.each(
        ...
        function (t, e) {
          w.fn[t] = function (t) {
            for (var n, i = [], o = w(t), r = o.length - 1, s = 0; s <= r; s++)
    ...
    function Kt(t, e, n, i, o, r) {
      ...
      for (; a < 4; a += 2)
        "margin" === n && (l += w.css(t, n + nt[a], !0, o)),
          i
            ? ("content" === n && (l -= w.css(t, "padding" + nt[a], !0, o)),
              "margin" !== n &&
                (l -= w.css(t, "border" + nt[a] + "Width", !0, o)))
            : ((l += w.css(t, "padding" + nt[a], !0, o)),
              "padding" !== n
                ? (l += w.css(t, "border" + nt[a] + "Width", !0, o))
                : (s += w.css(t, "border" + nt[a] + "Width", !0, o)));
      return (
        !i &&
          0 <= r &&
          (l +=
    ...
    function Zt(t, e, n) {
      ...
      return (
        ((!f.boxSizingReliable() && o) ||
          ...
          "auto" === a ||
          (!parseFloat(a) && "inline" === w.css(t, "display", !1, i))) &&
          t.getClientRects().length &&
          ((o = "border-box" === w.css(t, "boxSizing", !1, i)),
          (r = s in t) && (a = t[s])),
        (a = parseFloat(a) || 0) +
          Kt(t, e, n || (o ? "border" : "content"), r, i, a) +
          "px"
      );
    }
        ...
        w.cssHooks[e] = {
          ...
          set: function (t, n, i) {
            var o,
              ...
              s = (a || i) && "border-box" === w.css(t, "boxSizing", !1, r),
              l = i ? Kt(t, e, i, s, r) : 0;
            return (
              s &&
                a &&
          ...
          return W(
            ...
            function (t, e, n) {
              var i,
                ...
                a = 0;
              if (Array.isArray(e)) {
                for (i = Pt(t), o = e.length; a < o; a++)
                  r[e[a]] = w.css(t, e[a], !1, i);
                return r;
              }
    ...
    (w.Animation = w.extend(pe, {
            ...
            f))
              l ||
                (v
                  ...
                  : (v = J.access(t, "fxshow", { display: c })),
                r && (v.hidden = !g),
                g && ct([t], !0),
                d.done(function () {
                  for (i in (g || ct([t]), J.remove(t, "fxshow"), f))
                    w.style(t, i, f[i]);
                })),
                (l = ue(g ? v[i] : 0, i, d)),
                i in v ||
        ...
        stop: function (t, e, n) {
          ...
          return (
            ...
            this.each(function () {
              ...
              else for (o in a) a[o] && a[o].stop && ae.test(o) && i(a[o]);
              for (o = r.length; o--; )
                r[o].elem !== this ||
                  (null != t && r[o].queue !== t) ||
      ...
      (ie = v.createElement("input")),
      (oe = v.createElement("select").appendChild(v.createElement("option"))),
      (ie.type = "checkbox"),
      (f.checkOn = "" !== ie.value),
      (f.optSelected = oe.selected),
      ((ie = v.createElement("input")).value = "t"),
      (ie.type = "radio"),
        ...
        toggleClass: function (t, e) {
          ...
          return h(t)
            ...
            : ((n = ye(t)),
              this.each(function () {
                if (s)
                  for (r = w(this), o = 0; o < n.length; o++)
                    (i = n[o]),
                      r.hasClass(i) ? r.removeClass(i) : r.addClass(i);
                else
                  (void 0 !== t && "boolean" !== a) ||
                    ((i = me(this)) && J.set(this, "__className__", i),
                    this.setAttribute &&
                      this.setAttribute(
                        "class",
                        i || !1 === t ? "" : J.get(this, "__className__") || ""
                      ));
              }));
        },
        hasClass: function (t) {
          var e,
            ...
            i = 0;
          for (e = " " + t + " "; (n = this[i++]); )
            if (1 === n.nodeType && -1 < (" " + ve(me(n)) + " ").indexOf(e))
              return !0;
          return !1;
        },
      });
      ...
      w.extend({
        valHooks: {
          ...
          select: {
            ...
            set: function (t, e) {
              for (
                var n, i, o = t.options, r = w.makeArray(e), a = o.length;
                a--;
    ...
    w.extend(w.event, {
      trigger: function (e, n, i, o) {
        ...
        if (
          ...
          3 !== i.nodeType &&
            8 !== i.nodeType &&
            !xe.test(y + w.event.triggered) &&
            (-1 < y.indexOf(".") &&
              ((y = (b = y.split(".")).shift()), b.sort()),
            (c = y.indexOf(":") < 0 && "on" + y),
            ((e = e[w.expando]
              ? e
              : new w.Event(y, "object" == typeof e && e)).isTrigger = o
              ? 2
              : 3),
            (e.namespace = b.join(".")),
          ...
          if (!o && !d.noBubble && !g(i)) {
            for (
              l = d.delegateType || y, xe.test(l + y) || (a = a.parentNode);
              a;
              a = a.parentNode
            )
              m.push(a), (s = a);
            s === (i.ownerDocument || v) &&
              m.push(s.defaultView || s.parentWindow || t);
          }
          for (r = 0; (a = m[r++]) && !e.isPropagationStopped(); )
            (f = a),
              ...
              (p =
                ...
                J.get(a, "handle")) && p.apply(a, n),
              (p = c && a[c]) &&
                p.apply &&
                Q(a) &&
                ((e.result = p.apply(a, n)),
      ...
      w.extend({
        ...
        ajax: function (e, n) {
          ...
          if (
            ...
            try {
              (l.href = f.url),
                (l.href = l.href),
                (f.crossDomain =
                  qe.protocol + "//" + qe.host != l.protocol + "//" + l.host);
            } catch (e) {
              f.crossDomain = !0;
            }
          }
          ...
          f.hasContent
            ...
            : ((d = f.url.slice(o.length)),
              f.data &&
                ...
                ((o += ($e.test(o) ? "&" : "?") + f.data), delete f.data),
              !1 === f.cache &&
                ((o = o.replace(je, "$1")),
                (d = ($e.test(o) ? "&" : "?") + "_=" + Te.guid++ + d)),
              (f.url = o + d)),
          f.ifModified &&
            (w.lastModified[o] &&
              $.setRequestHeader("If-Modified-Since", w.lastModified[o]),
          ...
          if (
            ...
            if ((($.readyState = 1), u && g.trigger("ajaxSend", [$, f]), c))
              return $;
            f.async &&
              0 < f.timeout &&
              ...
              p
                ? (f.ifModified &&
                    ((C = $.getResponseHeader("Last-Modified")) &&
                      (w.lastModified[o] = C),
                    (C = $.getResponseHeader("etag")) && (w.etag[o] = C)),
                  204 === e || "HEAD" === f.type
                    ? (T = "nocontent")
                    : 304 === e
                    ? (T = "notmodified")
                    : ((T = x.state), (d = x.data), (p = !(v = x.error))))
                : ((v = T), (!e && T) || ((T = "error"), e < 0 && (e = 0))),
              ($.status = e),
              ($.statusText = (n || T) + ""),
              p ? m.resolveWith(h, [d, T, $]) : m.rejectWith(h, [$, T, v]),
              $.statusCode(b),
              (b = void 0),
              u &&
                g.trigger(p ? "ajaxSuccess" : "ajaxError", [$, f, p ? d : v]),
              y.fireWith(h, [$, T]),
              u &&
    ...
    w.ajaxSetup({
      ...
      w.ajaxPrefilter("json jsonp", function (e, n, i) {
        ...
        if (s || "jsonp" === e.dataTypes[0])
          return (
            ...
            s
              ? (e[s] = e[s].replace(Qe, "$1" + o))
              : !1 !== e.jsonp &&
                (e.url += ($e.test(e.url) ? "&" : "?") + e.jsonp + "=" + o),
      ...
      (f.createHTMLDocument =
        (((Ue = v.implementation.createHTMLDocument("").body).innerHTML =
          "<form></form><form></form>"),
      ...
      (w.fn.load = function (t, e, n) {
        var i,
          ...
          s = t.indexOf(" ");
        return (
          -1 < s && ((i = ve(t.slice(s))), (t = t.slice(0, s))),
          h(e)
            ? ((n = e), (e = void 0))
          ...
          0 < a.length &&
            w
              ...
              .done(function (t) {
                (r = arguments),
                  a.html(i ? w("<div>").append(w.parseHTML(t)).find(i) : t);
              })
              .always(
                n &&
                  function (t, e) {
      ...
      w.each(["top", "left"], function (t, e) {
        w.cssHooks[e] = Bt(f.pixelPosition, function (t, n) {
          if (n)
            return (n = Wt(t, e)), It.test(n) ? w(t).position()[e] + "px" : n;
        });
      }),
    ...
    return (
      (w.noConflict = function (e) {
        return (
          t.$ === w && (t.$ = Ye), e && t.jQuery === w && (t.jQuery = Je), w
        );
      }),
...
!(function (t) {
    ...
    (e.VERSION = "3.4.1"),
      ...
      (e.prototype.show = function () {
        if (!this.transitioning && !this.$element.hasClass("in")) {
          ...
          if (
            !(o && o.length && (n = o.data("bs.collapse")) && n.transitioning)
          ) {
      ...
      (n.prototype.toggle = function (e) {
        ...
        if (!n.is(".disabled, :disabled")) {
          ...
          if ((o(), !a)) {
            ...
            if (
              (r.trigger((e = t.Event("show.bs.dropdown", s))),
              e.isDefaultPrevented())
            )
              return;
        ...
        if (
          ...
          if (
            ...
            if ((!a && 27 != n.which) || (a && 27 == n.which))
              return (
                27 == n.which && r.find(e).trigger("focus"), o.trigger("click")
              );
        ...
        this.bodyIsOverflowing &&
          ...
          t(this.fixedContent).each(function (e, i) {
            ...
            t(i)
              ...
              .css("padding-right", parseFloat(r) + n + "px");
          }));
      }),
      ...
      t(document).on(
        ...
        function (e) {
          var i = t(this),
            ...
            s = a.data("bs.modal")
              ? "toggle"
              : t.extend({ remote: !/#/.test(o) && o }, a.data(), i.data());
  ...
  (function (t) {
    ...
    function a(e, n, i) {
      ...
      for (
        ...
        if (-1 !== t.inArray(p, a))
          for (
            var d = t.map(u.attributes, function (t) {
                return t;
              }),
              f = [].concat(n["*"] || [], n[p] || []),
              h = 0,
            ...
            r(d[h], f) || u.removeAttribute(d[h].nodeName);
    ...
    (s.VERSION = "3.4.1"),
        ...
        if (this.hasContent() && this.enabled) {
          ...
          c && (a = a.replace(l, "") || "top"),
            ...
            this.options.container
              ? o.appendTo(t(document).find(this.options.container))
      ...
      (s.prototype.getViewportAdjustedDelta = function (t, e, n, i) {
        ...
        if (/right|left/.test(t)) {
          ...
          c < a.left
            ? (o.left = a.left - c)
            : u > a.right && (o.left = a.left + a.width - u);
        }
        return o;
      }),
    ...
    (t.fn.tooltip = function (e) {
      return this.each(function () {
        ...
        (!i && /destroy|hide/.test(e)) ||
          (i || n.data("bs.tooltip", (i = new s(this, o))),
          "string" == typeof e && i[e]());
      });
    }),
    ...
    (e.VERSION = "3.4.1"),
      ...
      (e.prototype.checkPosition = function () {
        if (this.$element.is(":visible")) {
          ...
          "bottom" == s && this.$element.offset({ top: a - n - r });
        }
      });
    var i = t.fn.affix;
    (t.fn.affix = n),
      ...
      (e = {
        686: function (t, e, n) {
          ...
          function l(t, e) {
            ...
            (n = t),
              ...
              (t.style[i ? "right" : "left"] = "-9999px"),
              (i = window.pageYOffset || document.documentElement.scrollTop),
              (t.style.top = "".concat(i, "px")),
              t.setAttribute("readonly", ""),
              (t.value = n);
            return (
              e.container.appendChild(t), (e = r()(t)), a("copy"), t.remove(), e
            );
          }
          var c = function (t) {
            var e =
        ...
        370: function (t, e, n) {
          ...
          t.exports = function (t, e, n) {
            ...
            if (i.string(t)) return o(document.body, t, e, n);
            throw new TypeError(
  ...
  (function (t) {
    t.fn.conditionize = function (e) {
      var n = t.extend({ hideJS: !0 }, e);
      return (
        (t.fn.eval = function (t, e, n) {
          switch (n) {
            case "==":
              return t == e;
            case "!=":
        ...
        (t.fn.showOrHide = function (e, n, i, o) {
          (t(e).is("select, input[type=text]") &&
            t.fn.eval(t(e).val(), n, i)) ||
          t(e + ":checked").filter(function (e, o) {
        ...
        this.each(function () {
          var e = t(this)
            ...
            r = t(this).data("cond-operator")
              ? t(this).data("cond-operator")
              : "==",
            a = t(this);
  ...
  (window.onload = function () {
    ...
    "solvemedia" === app_vars.captcha_type &&
      (null === app_vars.user_id &&
        "1" === app_vars.captcha_short_anonymous &&
        $("#captchaShort").length &&
        (captchaShort = ACPuzzle.create(
          app_vars.solvemedia_challenge_key,
          "captchaShort",
          { multi: !0, id: "captchaShort" }
        )),
      "yes" === app_vars.captcha_contact &&
        $("#captchaContact").length &&
        (captchaContact = ACPuzzle.create(
          app_vars.solvemedia_challenge_key,
          "captchaContact",
          { multi: !0, id: "captchaContact" }
        )),
      "yes" === app_vars.captcha_signin &&
        $("#captchaSignin").length &&
        (captchaSignin = ACPuzzle.create(
          app_vars.solvemedia_challenge_key,
          "captchaSignin",
          { multi: !0, id: "captchaSignin" }
        )),
      "yes" === app_vars.captcha_signup &&
        $("#captchaSignup").length &&
        (captchaSignup = ACPuzzle.create(
          app_vars.solvemedia_challenge_key,
          "captchaSignup",
          { multi: !0, id: "captchaSignup" }
        )),
      "yes" === app_vars.captcha_forgot_password &&
        $("#captchaForgotpassword").length &&
        (captchaForgotpassword = ACPuzzle.create(
          app_vars.solvemedia_challenge_key,
          "captchaForgotpassword",
          { multi: !0, id: "captchaForgotpassword" }
        )),
      "yes" === app_vars.captcha_shortlink &&
        $("#captchaShortlink").length &&
        (captchaShortlink = ACPuzzle.create(
          app_vars.solvemedia_challenge_key,
          "captchaShortlink",
          { multi: !0, id: "captchaShortlink" }
        )));
  });
var onloadRecaptchaCallback = function () {
    if ("yes" !== app_vars.enable_captcha) return !0;
    "recaptcha" === app_vars.captcha_type &&
      (null === app_vars.user_id &&
        "1" === app_vars.captcha_short_anonymous &&
        $("#captchaShort").length &&
      ...
      "invisible-recaptcha" === app_vars.captcha_type &&
        (null === app_vars.user_id &&
          "1" === app_vars.captcha_short_anonymous &&
          $("#captchaShort").length &&
          ((invisibleCaptchaShort = grecaptcha.render("captchaShort", {
            ...
            size: "invisible",
            callback: function (t) {
              grecaptcha.getResponse(invisibleCaptchaShort) &&
                $("#shorten").addClass("captcha-done").submit();
            },
          })),
          $("#shorten").submit(function (t) {
            grecaptcha.getResponse(invisibleCaptchaShort) ||
              (t.preventDefault(), grecaptcha.execute(invisibleCaptchaShort));
          })),
        "yes" === app_vars.captcha_contact &&
          $("#captchaContact").length &&
          ((invisibleCaptchaContact = grecaptcha.render("captchaContact", {
            ...
            size: "invisible",
            callback: function (t) {
              grecaptcha.getResponse(invisibleCaptchaContact) &&
                $("#contact-form").addClass("captcha-done").submit();
            },
          })),
          $("#contact-form").submit(function (t) {
            grecaptcha.getResponse(invisibleCaptchaContact) ||
              (t.preventDefault(), grecaptcha.execute(invisibleCaptchaContact));
          })),
        "yes" === app_vars.captcha_signin &&
          $("#captchaSignin").length &&
          ...
          $("#signin-form").submit(function (t) {
            grecaptcha.getResponse(invisibleCaptchaSignin) ||
              (t.preventDefault(), grecaptcha.execute(invisibleCaptchaSignin));
          })),
        "yes" === app_vars.captcha_signup &&
          $("#captchaSignup").length &&
          ...
          $("#signup-form").submit(function (t) {
            grecaptcha.getResponse(invisibleCaptchaSignup) ||
              (t.preventDefault(), grecaptcha.execute(invisibleCaptchaSignup));
          })),
        "yes" === app_vars.captcha_forgot_password &&
          $("#captchaForgotpassword").length &&
          ...
          $("#forgotpassword-form").submit(function (t) {
            grecaptcha.getResponse(invisibleCaptchaForgotpassword) ||
              (t.preventDefault(),
        ...
        "yes" === app_vars.captcha_shortlink &&
          ...
          $("#link-view").submit(function (t) {
            grecaptcha.getResponse(invisibleCaptchaShortlink) ||
              (t.preventDefault(),
              grecaptcha.execute(invisibleCaptchaShortlink));
          })));
  },
  onloadHCaptchaCallback = function () {
    if ("yes" !== app_vars.enable_captcha) return !0;
    "hcaptcha_checkbox" === app_vars.captcha_type &&
      (null === app_vars.user_id &&
        "1" === app_vars.captcha_short_anonymous &&
        $("#captchaShort").length &&
        ($("#shorten .btn-captcha").attr("disabled", "disabled"),
...
if (
  -1 !== ["recaptcha", "invisible-recaptcha"].indexOf(app_vars.captcha_type)
) {
...
if ("hcaptcha_checkbox" === app_vars.captcha_type) {
  let t = document.createElement("script");
  (t.src =
    "https://hcaptcha.com/1/api.js?onload=onloadHCaptchaCallback&render=explicit"),
    (t.async = !0),
    (t.defer = !0),
    document.body.appendChild(t);
}
if ("solvemedia" === app_vars.captcha_type) {
  ...
  (t.type = "text/javascript"),
    "https:" === location.protocol
      ? (t.src = "https://api-secure.solvemedia.com/papi/challenge.ajax")
      : (t.src = "http://api.solvemedia.com/papi/challenge.ajax"),
    document.body.appendChild(t);
}
...
function checkAdblockUser() {
  if ("1" !== getCookie("ab")) {
    ...
    var t = $("#ad-banner");
    if (
      (0 === t.filter(":visible").length ||
        t.filter(":hidden").length > 0 ||
        0 === t.height()) &&
...
function checkAdsbypasserUser() {
  if ("1" !== getCookie("ab")) {
    ...
    (document.cookie = "ab=2; path=/"),
      ["AdsBypasser", "SafeBrowse"].indexOf(t) >= 0 &&
        (document.cookie = "ab=1; path=/");
  }
}
  ...
  "function" == typeof Promise &&
    new Promise(function (t) {
      ...
      window.webkitRequestFileSystem
        ? webkitRequestFileSystem(0, 0, i, n)
        ...
        ? (function () {
            try {
              localStorage.length ||
                ((localStorage.x = 1), localStorage.removeItem("x")),
                i();
            } catch (t) {
...
go_popup.length &&
  ($(document).one("click.adLinkFly.goPopupClick", function (t) {
    go_popup.submit();
  }),
...
var body = $("body"),
  ad_type = "";
body.hasClass("banner-page")
  ? (ad_type = "banner")
  : body.hasClass("interstitial-page") && (ad_type = "interstitial");
var counter_start_object = document;
"load" === app_vars.counter_start && (counter_start_object = window),
  $(counter_start_object).on(
    app_vars.counter_start + ".adLinkFly.checkAdblockers",
    function (t) {
  ...
  $(counter_start_object).on(
    app_vars.counter_start + ".adLinkFly.counter",
    function (t) {
      if ("banner" === ad_type) {
        var e = $("#timer");
        window.setTimeout(function () {
          var t,
            n = 1e3 * app_vars.counter_value;
          ...
          t.url
            ? ("banner" === ad_type &&
              ...
              "interstitial" === ad_type &&
                $(".skip-ad a").attr("href", t.url).removeAttr("onclick"))
            : alert(t.message);
        },
  ...
  $("body").one(
    "focus.adLinkFly.displayShortenCaptcha",
    "#shorten input#url",
    function (t) {
  ...
  $(document).ready(function () {
    ...
    "#" === t.substr(-1) &&
      history.pushState("", document.title, t.substr(0, t.length - 1));
        ...
        .resize(function () {
          ...
          (t = 0),
            $("header.main-header").length
              ...
              : $("#mainNav.navbar").length &&
                (t = $("#mainNav.navbar").outerHeight()),
...
$("#form-settings").length && null !== selectedTab
  ? $('#form-settings a[data-toggle="tab"][href="#' + selectedTab + '"]').tab(
      "show"
    )
  : $('#form-settings a[data-toggle="tab"]:first').tab("show"),
  $(".shorten-member #shorten").on(
    "submit.adLinkFly.memberShortLinkForm",
    function (t) {
      t.preventDefault();
      var e = $(this),
      ...
      $.ajax({
        ...
        beforeSend: function (t) {
          i
            ...
            ).insertAfter(n.find(".box-body"));
        },
        success: function (t, e, n) {
          if (t.url) {
            var i =
              '<div class="form-group"><div class="input-group"><input class="form-control input-lg" value="' +
              t.url +
              '" readonly onfocus="javascript:this.select()" ><div class="input-group-addon copy-it" data-clipboard-text="' +
              t.url +
            ...
            var o =
              '<div class="form-group"><p></p><div class="alert alert-danger" role="alert">' +
              t.message +
              "</div></div>";
  ...
  $(".shorten #shorten").on("submit.adLinkFly.homeShortLinkForm", function (t) {
    if (
      ...
      if (
        "invisible-recaptcha" === app_vars.captcha_type &&
        "yes" === app_vars.enable_captcha &&
        "1" === app_vars.captcha_short_anonymous &&
        $("#captchaContact").length &&
        !$(this).hasClass("captcha-done")
      )
        return !1;
      var e = $(this),
        n = e.find("button");
        ...
        success: function (t, n, i) {
          if (t.url) {
            ...
            var o =
              ...
              app_vars.copy +
              '"><i class="fa fa-clone"></i></div><div class="input-group-addon reshort" data-toggle="tooltip" data-placement="bottom" title="Reshort"><i class="fa fa-refresh"></i></div></div></div>';
            $(".shorten.add-link-result").html(o).slideDown();
          } else {
            e.slideUp();
            var r =
              '<div class="form-group"><div class="input-group"><input class="form-control input-lg" value="' +
              t.message +
              '" readonly ><div class="input-group-addon reshort" data-toggle="tooltip" data-placement="bottom" title="Reshort"><i class="fa fa-refresh"></i></div></div></div>';
...
function cookie_accept() {
  var t =
    '<div id="cookie-pop"><div class="container-fluid"><div class="col-xs-9"><div class="cookie-message">' +
    app_vars.cookie_message +
    '</div></div><div class="col-xs-3"><div class="cookie-confirm"><button id="got-cookie" class="btn btn-default" type="submit">' +
  ...
  ($.AdminLTE.layout = {
    ...
    fix: function () {
      ...
      if ($("body").hasClass("fixed"))
        ...
        var o;
        n >= i
          ? ($(".content-wrapper, .right-side").css("min-height", n - e),
            (o = n - e))
          : ($(".content-wrapper, .right-side").css("min-height", i), (o = i));
        var r = $($.AdminLTE.options.controlSidebarOptions.selector);
        void 0 !== r &&
          r.height() > o &&
          $(".content-wrapper, .right-side").css("min-height", r.height());
      }
    },
    fixSidebar: function () {
    ...
    ($.AdminLTE.controlSidebar = {
      activate: function () {
        ...
        $(e.toggleBtnSelector).on("click", function (i) {
          i.preventDefault(),
            n.hasClass("control-sidebar-open") ||
      ...
      open: function (t, e) {
        e
          ? t.addClass("control-sidebar-open")
          : $("body").addClass("control-sidebar-open");
      },
      close: function (t, e) {
        e
          ? t.removeClass("control-sidebar-open")
    ...
    ($.AdminLTE.boxWidget = {
      ...
      collapse: function (t) {
        ...
        n.hasClass("collapsed-box")
          ? (t
              .children(":first")
              .removeClass(e.icons.open)
              .addClass(e.icons.collapse),
            i.slideDown(e.animationSpeed, function () {
              n.removeClass("collapsed-box");
            }))
          : (t
              .children(":first")
              .removeClass(e.icons.collapse)
              .addClass(e.icons.open),
...
if (
  ...
  app_vars.cookie_notification_bar &&
    "" === getCookie("cookieLaw") &&
    (cookie_accept(),
    $("#cookie-pop").show(),
    ...
    _init(),
      ...
      t.navbarMenuSlimscroll &&
        ...
        $(".navbar .menu")
          ...
          .css("width", "100%"),
      t.sidebarPushMenu &&
        $.AdminLTE.pushMenu.activate(t.sidebarToggleSelector),
      t.enableBSToppltip &&
        $("body").tooltip({ selector: t.BSTooltipSelector, container: "body" }),
      ...
      t.directChat.enable &&
        $(document).on(
          "click",
          t.directChat.contactToggleSelector,
          function () {
            $(this)
              .parents(".direct-chat")
              .first()
