if (
  ((function (t, e) {
    ...
    var C = (function (t) {
      ...
      try {
        O.apply((D = L.call(x.childNodes)), x.childNodes),
      ...
      function at(t, e, i, o) {
        ...
        if (!o && (p(e), (e = e || d), g)) {
          ...
          if (
            ...
            if (((v = t), (y = e), 1 === x && (U.test(t) || B.test(t)))) {
              for (
        ...
        return (
          ...
          ct(function (r, s, a, l) {
            var c,
              ...
              m = !t || (!r && e) ? g : _t(g, p, t, a, l),
              v = n ? (o || (r ? t : f || i) ? [] : s) : m;
            if ((n && n(m, v, a, l), i))
              for (c = _t(v, d), i(c, [], a, l), u = c.length; u--; )
                (h = c[u]) && (v[d[u]] = !(m[d[u]] = h));
            if (r) {
              if (o || t) {
                if (o) {
            ...
            } else (v = _t(v === s ? v.splice(f, v.length) : v)), o ? o(null, s, v, l) : O.apply(s, v);
          })
        );
      }
      function Tt(t) {
              ...
              (m = k(
                ...
                (u = function (t, e, n, s, u) {
                  ...
                  for (
                    ...
                    if (l && h) {
                      for (
                        f = 0, e || h.ownerDocument == d || (p(h), (n = !g));
                        (m = o[f++]);
      ...
      if (((n = n || D), "string" == typeof t)) {
        ...
        if (i[1]) {
          if (
            ...
            x.merge(
              this,
              x.parseHTML(i[1], e && e.nodeType ? e.ownerDocument || e : m, !0)
            ),
            E.test(i[1]) && x.isPlainObject(e))
          )
        ...
        function (t, e) {
          x.fn[t] = function (n, i) {
            ...
            return (
              ...
              1 < this.length &&
                (O[t] || x.uniqueSort(o), j.test(t) && o.reverse()),
              this.pushStack(o)
            );
          };
        }
    ...
    (x.Callbacks = function (t) {
      ...
      x.extend({
          ...
          var n = [
            ...
            o = {
              ...
              then: function (e, i, o) {
                        ...
                        : function () {
                            try {
                              ...
                              x.Deferred.exceptionHook &&
                                x.Deferred.exceptionHook(t, u.stackTrace),
                                r <= e + 1 &&
                                  (i !== H && ((a = void 0), (l = [t])),
                                  n.rejectWith(a, l));
                            }
                ...
                return x
                  .Deferred(function (t) {
                    n[0][3].add(s(0, t, f(o) ? o : I, t.notifyWith)),
                      n[1][3].add(s(0, t, f(e) ? e : I)),
                      n[2][3].add(s(0, t, f(i) ? i : H));
                  })
                  .promise();
              },
              promise: function (t) {
        ...
        when: function (t) {
          ...
          if (
            e <= 1 &&
            (R(t, s.done(a(n)).resolve, s.reject, !e),
      ...
      x.fn.extend({
        data: function (t, e) {
          ...
          if (void 0 === t) {
            if (
              this.length &&
              ((o = G.get(r)), 1 === r.nodeType && !Y.get(r, "hasDataAttrs"))
            ) {
              for (n = s.length; n--; )
                s[n] &&
                  0 === (i = s[n].name).indexOf("data-") &&
                  ((i = V(i.slice(5))), K(r, i, o[i]));
    ...
    var st = function (t, e) {
      return (
        ...
        ("" === t.style.display && ot(t) && "none" === x.css(t, "display"))
      );
    };
    function at(t, e, n, i) {
      var o,
    ...
    (ut = m.createDocumentFragment().appendChild(m.createElement("div"))),
      ...
      ut.appendChild(ht),
      (d.checkClone = ut.cloneNode(!0).cloneNode(!0).lastChild.checked),
      (ut.innerHTML = "<textarea>x</textarea>"),
      (d.noCloneChecked = !!ut.cloneNode(!0).lastChild.defaultValue),
      (ut.innerHTML = "<option></option>"),
      (d.option = !!ut.lastChild);
    var gt = {
      thead: [1, "<table>", "</table>"],
      ...
      return (
        (n =
          void 0 !== t.getElementsByTagName
            ...
            : []),
        void 0 === e || (e && S(t, e)) ? x.merge([t], n) : n
      );
    }
    function vt(t, e) {
    ...
    function bt(t, e, n, i, o) {
      ...
      for (h.textContent = "", d = 0; (r = p[d++]); )
        if (i && -1 < x.inArray(r, i)) o && o.push(r);
          ...
          ((c = ot(r)), (s = mt(h.appendChild(r), "script")), c && vt(s), n)
        )
    ...
    function $t(t, e, n) {
      n
        ...
        : void 0 === Y.get(t, e) && x.event.add(t, e, xt);
    }
    (x.event = {
      global: {},
          ...
          for (c = (e = (e || "").match(P) || [""]).length; c--; )
            if (
              ...
              s &&
                ...
                delete l[d]);
            } else for (d in l) x.event.remove(t, d + e[c], n, i, !0);
      ...
      dispatch: function (t) {
        ...
        if (
          ...
          for (
            s = x.event.handlers.call(this, l, c), e = 0;
      ...
      special: {
        ...
        click: {
          setup: function (t) {
            var e = this || t;
            return (
              pt.test(e.type) && e.click && S(e, "input") && $t(e, "click", xt),
              !1
            );
          },
          trigger: function (t) {
            var e = this || t;
            return (
              pt.test(e.type) && e.click && S(e, "input") && $t(e, "click"), !0
            );
          },
          _default: function (t) {
            var e = t.target;
    ...
    function jt(t, e) {
      ...
      if (1 === e.nodeType) {
        ...
        G.hasData(t) && ((r = G.access(t)), (s = x.extend({}, r)), G.set(e, s));
      }
    }
    function Ot(t, e, n, i) {
      e = r(e);
      var o,
        ...
        m = e[0],
        v = f(m);
      if (v || (1 < p && "string" == typeof m && !d.checkClone && St.test(m)))
        return t.each(function (o) {
          var r = t.eq(o);
          v && (e[0] = m.call(this, o, r.html())), Ot(r, e, n, i);
        });
      if (
        p &&
        ((s = (o = bt(e, t[0].ownerDocument, !1, t, i)).firstChild),
        1 === o.childNodes.length && (o = s),
        s || i)
      ) {
        for (l = (a = x.map(mt(o, "script"), Dt)).length; h < p; h++)
          (c = o),
            h !== g &&
              ((c = x.clone(c, !0, !0)), l && x.merge(a, mt(c, "script"))),
            n.call(t[h], c, h);
        if (l)
          for (
            u = a[a.length - 1].ownerDocument, x.map(a, Nt), h = 0;
            h < l;
            h++
          )
            (c = a[h]),
              ft.test(c.type || "") &&
                ...
                (c.src && "module" !== (c.type || "").toLowerCase()
                  ...
                  : y(c.textContent.replace(Et, ""), c, u));
      }
      return t;
    }
    function Lt(t, e, n) {
      for (var i, o = e ? x.filter(e, t) : t, r = 0; null != (i = o[r]); r++)
        n || 1 !== i.nodeType || x.cleanData(mt(i)),
          i.parentNode &&
            (n && ot(i) && vt(mt(i, "script")), i.parentNode.removeChild(i));
      return t;
    }
    x.extend({
      ...
      cleanData: function (t) {
        for (
          var e, n, i, o = x.event.special, r = 0;
          void 0 !== (n = t[r]);
          r++
        )
          if (Q(n)) {
        ...
        replaceWith: function () {
          ...
          return Ot(
            ...
            function (e) {
              ...
              x.inArray(this, t) < 0 &&
                (x.cleanData(mt(this)), n && n.replaceChild(e, this));
            },
            t
          );
        },
    ...
    function Ft(t, e, n) {
      ...
      return (
        (n = n || Ht(t)) &&
          ...
          a && s && (s = s.replace(qt, "$1") || void 0),
          "" !== s || ot(t) || (s = x.style(t, e)),
          !d.pixelBoxStyles() &&
            Pt.test(s) &&
            zt.test(e) &&
            ((i = l.width),
      ...
      return (
        ...
        (t in Ut
          ...
          : (Vt[t] =
              (function (t) {
                for (
                  var e = t[0].toUpperCase() + t.slice(1), n = Bt.length;
                  n--;

                )
                  if ((t = Bt[n] + e) in Ut) return t;
              })(t) || t))
      );
    }
    ...
    function Jt(t, e, n, i, o, r) {
      ...
      for (; s < 4; s += 2)
        "margin" === n && (l += x.css(t, n + nt[s], !0, o)),
          i
            ? ("content" === n && (l -= x.css(t, "padding" + nt[s], !0, o)),
              "margin" !== n &&
                (l -= x.css(t, "border" + nt[s] + "Width", !0, o)))
            : ((l += x.css(t, "padding" + nt[s], !0, o)),
              "padding" !== n
                ? (l += x.css(t, "border" + nt[s] + "Width", !0, o))
                : (a += x.css(t, "border" + nt[s] + "Width", !0, o)));
      return (
        !i &&
          0 <= r &&
          (l +=
    ...
    function Kt(t, e, n) {
      ...
      return (
        ((!d.boxSizingReliable() && o) ||
          (!d.reliableTrDimensions() && S(t, "tr")) ||
          "auto" === s ||
          (!parseFloat(s) && "inline" === x.css(t, "display", !1, i))) &&
          t.getClientRects().length &&
          ((o = "border-box" === x.css(t, "boxSizing", !1, i)),
          (r = a in t) && (s = t[a])),
        (s = parseFloat(s) || 0) +
          Jt(t, e, n || (o ? "border" : "content"), r, i, s) +
          "px"
      );
    }
    ...
    x.extend({
      ...
      x.each(["height", "width"], function (t, e) {
        x.cssHooks[e] = {
          get: function (t, n, i) {
            if (n)
              return !Xt.test(x.css(t, "display")) ||
      ...
      (x.cssHooks.marginLeft = Wt(d.reliableMarginLeft, function (t, e) {
        if (e)
          return (
        ...
        _default: {
          ...
          set: function (t) {
            x.fx.step[t.prop]
              ? x.fx.step[t.prop](t)
              : 1 !== t.elem.nodeType ||
                (!x.cssHooks[t.prop] && null == t.elem.style[Qt(t.prop)])
              ? (t.elem[t.prop] = t.now)
    ...
    function he(t, e, n) {
      ...
      for (
        ...
        if ((i = he.prefilters[r].call(c, t, u, c.opts)))
          return (
            f(i.stop) &&
    ...
    (x.Animation = x.extend(he, {
          ...
          if ((l = !x.isEmptyObject(e)) || !x.isEmptyObject(d))
            ...
            d))
              l ||
                ...
                g && ct([t], !0),
                p.done(function () {
                  for (i in (g || ct([t]), Y.remove(t, "fxshow"), d))
                    x.style(t, i, d[i]);
                })),
                (l = ue(g ? m[i] : 0, i, p)),
                i in m ||
      ...
      (ie.type = "checkbox"),
      (d.checkOn = "" !== ie.value),
      (d.optSelected = oe.selected),
      ((ie = m.createElement("input")).value = "t"),
      (ie.type = "radio"),
      (d.radioValue = "t" === ie.value);
    var pe,
            ...
            return void 0 === t.getAttribute
              ...
              : ((1 === r && x.isXMLDoc(t)) ||
                  (o =
                    ...
                    (x.expr.match.bool.test(e) ? pe : void 0)),
                void 0 !== n
                  ? null === n
        ...
        propHooks: {
          tabIndex: {
            get: function (t) {
              ...
              return e
                ? parseInt(e, 10)
                : fe.test(t.nodeName) || (ge.test(t.nodeName) && t.href)
                ? 0
                : -1;
            },
          },
        ...
        addClass: function (t) {
          ...
          return f(t)
            ...
            ? this.each(function () {
                if (
                  ((i = ve(this)),
                  (n = 1 === this.nodeType && " " + me(i) + " "))
                ) {
                  for (r = 0; r < e.length; r++)
                    (o = e[r]), n.indexOf(" " + o + " ") < 0 && (n += o + " ");
                  (s = me(n)), i !== s && this.setAttribute("class", s);
                }
              })
            : this;
        },
        ...
        toggleClass: function (t, e) {
          ...
          return f(t)
            ...
            : ((n = ye(t)),
              this.each(function () {
                if (a)
                  for (r = x(this), o = 0; o < n.length; o++)
                    (i = n[o]),
                      r.hasClass(i) ? r.removeClass(i) : r.addClass(i);
                else
                  (void 0 !== t && "boolean" !== s) ||
                    ((i = ve(this)) && Y.set(this, "__className__", i),
                    this.setAttribute &&
                      this.setAttribute(
                        "class",
                        i || !1 === t ? "" : Y.get(this, "__className__") || ""
                      ));
              }));
        },
        hasClass: function (t) {
      ...
      x.extend({
        valHooks: {
          ...
          select: {
            ...
            set: function (t, e) {
              for (
                var n, i, o = t.options, r = x.makeArray(e), s = o.length;
                s--;
    ...
    x.extend(x.event, {
      trigger: function (e, n, i, o) {
        ...
        if (
          ...
          if (!o && !p.noBubble && !g(i)) {
            for (
              l = p.delegateType || y, we.test(l + y) || (s = s.parentNode);
              s;
              s = s.parentNode
            )
              v.push(s), (a = s);
    ...
    function Ae(t, e, n, i) {
      ...
      else for (o in e) Ae(t + "[" + o + "]", e[o], n, i);
    }
      ...
      x.extend({
        ...
        ajax: function (e, n) {
          ...
          var i,
            ...
            d = x.ajaxSetup({}, n),
            f = d.context || d,
            g = d.context && (f.nodeType || f.jquery) ? x(f) : x.event,
            v = x.Deferred(),
          ...
          if (
            ...
            try {
              (l.href = d.url),
                (l.href = l.href),
                (d.crossDomain =
                  ze.protocol + "//" + ze.host != l.protocol + "//" + l.host);
            } catch (e) {
              d.crossDomain = !0;
            }
          }
          if (
            (d.data &&
              ...
              (d.data = x.param(d.data, d.traditional)),
            qe(Ie, d, n, T),
            c)
          )
            return T;
          for (h in ((u = x.event && d.global) &&
            0 == x.active++ &&
          ...
          d.hasContent
            ...
            : ((p = d.url.slice(o.length)),
              d.data &&
                ...
                ((o += (Te.test(o) ? "&" : "?") + d.data), delete d.data),
              !1 === d.cache &&
                ((o = o.replace(je, "$1")),
                (p = (Te.test(o) ? "&" : "?") + "_=" + Ce.guid++ + p)),
              (d.url = o + p)),
          d.ifModified &&
            (x.lastModified[o] &&
          ...
          T.setRequestHeader(
            ...
            d.dataTypes[0] && d.accepts[d.dataTypes[0]]
              ? d.accepts[d.dataTypes[0]] +
                  ("*" !== d.dataTypes[0] ? ", " + Re + "; q=0.01" : "")
              : d.accepts["*"]
          ),
          d.headers))
            T.setRequestHeader(h, d.headers[h]);
          if (d.beforeSend && (!1 === d.beforeSend.call(f, T, d) || c))
            return T.abort();
          if (
            ((C = "abort"),
            y.add(d.complete),
          ...
          function $(e, n, s, l) {
            ...
            c ||
              ...
              !h &&
                -1 < x.inArray("script", d.dataTypes) &&
                x.inArray("json", d.dataTypes) < 0 &&
              ...
              h
                ? (d.ifModified &&
                    ((_ = T.getResponseHeader("Last-Modified")) &&
                      (x.lastModified[o] = _),
                    (_ = T.getResponseHeader("etag")) && (x.etag[o] = _)),
                  204 === e || "HEAD" === d.type
                    ? (C = "nocontent")
                    : 304 === e
                    ? (C = "notmodified")
                    : ((C = w.state), (p = w.data), (h = !(m = w.error))))
                : ((m = C), (!e && C) || ((C = "error"), e < 0 && (e = 0))),
              (T.status = e),
              (T.statusText = (n || C) + ""),
              h ? v.resolveWith(f, [p, C, T]) : v.rejectWith(f, [T, C, m]),
              T.statusCode(b),
              (b = void 0),
              u &&
                g.trigger(h ? "ajaxSuccess" : "ajaxError", [T, d, h ? p : m]),
              y.fireWith(f, [T, C]),
              u &&
    ...
    x.ajaxSetup({
      ...
      jsonpCallback: function () {
        var t = Ve.pop() || x.expando + "_" + Ce.guid++;
        return (this[t] = !0), t;
      },
    }),
      ...
      (d.createHTMLDocument =
        (((Ue = m.implementation.createHTMLDocument("").body).innerHTML =
          "<form></form><form></form>"),
      ...
      (x.fn.load = function (t, e, n) {
        var i,
          ...
          a = t.indexOf(" ");
        return (
          -1 < a && ((i = me(t.slice(a))), (t = t.slice(0, a))),
          f(e)
            ? ((n = e), (e = void 0))
      ...
      x.each(["top", "left"], function (t, e) {
        x.cssHooks[e] = Wt(d.pixelPosition, function (t, n) {
          if (n)
            return (n = Ft(t, e)), Pt.test(n) ? x(t).position()[e] + "px" : n;
        });
      }),
    ...
    return (
      (x.noConflict = function (e) {
        return (
          t.$ === x && (t.$ = Ge), e && t.jQuery === x && (t.jQuery = Ye), x
        );
      }),
      ...
      (n.prototype.toggle = function (e) {
        ...
        if (!n.is(".disabled, :disabled")) {
          ...
          if ((o(), !s)) {
            ...
            if (
              (r.trigger((e = t.Event("show.bs.dropdown", a))),
              e.isDefaultPrevented())
            )
              return;
      ...
      for (
        ...
        if (-1 !== t.inArray(h, s))
          for (
            ...
            r(p[f], d) || u.removeAttribute(p[f].nodeName);
      ...
      (a.prototype.show = function () {
        ...
        if (this.hasContent() && this.enabled) {
          ...
          if (c) {
            ...
            (s =
              "bottom" == s && u.bottom + p > f.bottom
                ? "top"
                : "top" == s && u.top - p < f.top
                ? "bottom"
                : "right" == s && u.right + h > f.width
                ? "left"
                : "left" == s && u.left - h < f.left
                ? "right"
                : s),
              o.removeClass(d).addClass(s);
          }
          var g = this.getCalculatedOffset(s, u, h, p);
      ...
      (a.prototype.setContent = function () {
        ...
        this.options.html
          ? (this.options.sanitize &&
              (e = s(e, this.options.whiteList, this.options.sanitizeFn)),
    ...
    (t.fn.tooltip = function (e) {
      return this.each(function () {
        ...
        (!i && /destroy|hide/.test(e)) ||
          (i || n.data("bs.tooltip", (i = new a(this, o))),
          "string" == typeof e && i[e]());
      });
    }),
        ...
        686: function (t, e, n) {
          ...
          function l(t, e) {
            ...
            (n = t),
              ...
              (t.value = n);
            return (
              e.container.appendChild(t), (e = r()(t)), s("copy"), t.remove(), e
            );
          }
          var c = function (t) {
            var e =
              ...
              r = (function (t) {
                ...
                return function () {
                  ...
                  return (
                    ...
                    (i = this),
                    !n || ("object" !== h(n) && "function" != typeof n)
                      ? (function (t) {
...
$("#mainNav.navbar-fixed-top").affix({ offset: { top: 100 } }),
  $(window)
    .resize(function () {
      fixHeight();
    })
  ...
  $(document).ready(function () {
    $(".testimonials").owlCarousel({ items: 1, margin: 10, loop: !0 }),
      ...
      $(".payout-rates > div.tab-content div.tab-pane:first-child").addClass(
        "active"
      );
  }),
  $("#contact-form").submit(function (t) {
    ...
    $.ajax({
      ...
      beforeSend: function (t) {
        n.attr("disabled", !0).html('<i class="fa fa-spinner fa-spin"></i>'),
          $('<div class="loader"></div>').insertAfter(e);
      },
